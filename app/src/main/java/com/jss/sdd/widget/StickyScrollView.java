...
public class StickyScrollView extends NestedScrollView
{
    ...
    public boolean dispatchTouchEvent(MotionEvent ev)
    {
        ...
        if (redirectTouchesToStickyView)
        {
            ...
            if (redirectTouchesToStickyView)
            {
                redirectTouchesToStickyView = ev.getY() <= (currentlyStickingView.getHeight() + stickyViewTopOffset) && ev.getX() >=
                        getLeftForViewRelativeOnlyChild(currentlyStickingView) && ev.getX() <= getRightForViewRelativeOnlyChild
