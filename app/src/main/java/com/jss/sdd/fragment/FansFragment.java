...
import com.jss.sdd.adapter.FansAdapter;
import com.jss.sdd.adapter.OrderAdapter;
 ...
 * 粉丝
 */
public class FansFragment extends BaseFragment implements IRequestListener
{
    ...
    private List<FansInfo> fansInfoList = new ArrayList<>();
        ...
        public void handleMessage(Message msg)
        {
            ...
            switch (msg.what)
            {
                case REQUEST_SUCCESS:
                    ...
                    // orderInfoList.addAll(mGoodsListHandler.getGoodsInfoList());

                    for (int i = 0; i < 40; i++)
                    {
                        fansInfoList.add(new FansInfo());
                    }
    ...
    protected void initViewData()
    {
        ...
        mFansAdapter = new FansAdapter(fansInfoList, getActivity());
